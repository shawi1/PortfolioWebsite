...
const About = () => { 
  return (
    <div
      name="about"
      id="about"
      className="w-full h-screen text-[#D1D5DB]"
    >
      <div className="flex flex-col justify-center items-center w-full h-full">
        <div className=" py-16 rounded-md bg-[#497C7E] flex flex-col justify-center items-center w-4/6">
          <div className="max-w-[1000px] w-full grid grid-cols-2 gap-8 mb-4">
            <div className="sm:text-right pb-8 pl-4">
              <p className="text-4xl font-bold inline border-b-4 border-[#E3C16F]">
                About
              </p>
            </div>
            <div></div>
          ...
          <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
            <div className="sm:text-right text-4xl font-bold">
              <p>
                Hi. I'm Sean Hawi, nice to meet you. Please take a
                look around.
              </p>
            </div>
            <div>
